...
- Optional hooks that reinforce routing and derived-agent scope, and block unmarked interruption of running subagents. Close ordering remains a Skill rule owned by the main agent; the Hook does not claim to enforce it.
